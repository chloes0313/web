...
public interface ReviewManagementService {
	 ...
	 * 전체조회 회원 아이디 정렬
	 */
	void selectAllReviewOrderByMemberId();
	
	/**
	 * 전체조회 최근등록순 정렬
	 */
	void selectAllReviewOrderByNewestRegistered();
	
	/**
	 * 특정 등록일 조회
	 * @param registeredDate
	 */
	void selectReviewByRegisteredDate(Date registeredDate);
	 ...
	 * @param toDate
	 */
	void selectReviewByRegisteredDateRange(Date fromDate, Date toDate);
	
	/**
	 * 제목으로 조회
	 * @param title
	 */
	void selectReviewByTitle(String title);
	
	/**
	 * 내용으로 조회
	 * @param comments
	 */
	void selectReviewByComments(String comments);
	 ...
	 * @return
	 */
	void selectReviewByNo(int reviewNo);
