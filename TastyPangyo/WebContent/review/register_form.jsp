			...
			<fieldset class="review_form" size="150">
				...
				<div class="row_group">
					<!-- 필수입력값(NOT NULL이여야 하는)은 input 속성으로 required를 줘서 반드시 입력값을 받고 넘어가게 하고
					 oninvalid  -->
					식당번호 <input id="readonly" name="restaurantId" value="${ requestScope.selectRes.restaurantId }"
							size="40" readonly ><br>
					식당명 <input id="readonly" name="restaurantName" value="${ requestScope.selectRes.restaurantName }" 
							size="40" readonly><br>
