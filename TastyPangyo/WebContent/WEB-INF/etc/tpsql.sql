...
insert into member values('lbm', '111', '이병문', '2017,01,01');
insert into member values('lsh', '222', '이승헌', '2017,02,01');
insert into member values('jgh', '555', '장규현', '2017,03,01');
insert into member values('sey', '777', '성은영', '2017,04,01');
insert into member values('sey0313', '777', '끌로이', '2016,04,01');
...
INSERT INTO review VALUES	(review_no_seq.nextval ,'jjj',5,'청년다방','2017-05-05' ,'떡볶이이','맛난다',7);
INSERT INTO review VALUES	(review_no_seq.nextval ,'jjj',6,'신기소','2017-05-05' ,'돈까스','맛난다',5);
INSERT INTO review VALUES	(review_no_seq.nextval ,'jjj',50,'고메부인','2017-05-05' ,'떡볶이이','맛난다',7);
