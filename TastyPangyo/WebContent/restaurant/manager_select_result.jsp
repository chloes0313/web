...
width:120%;
height:200px;
background:url('/TastyPangyo/2.jpg') no-repeat ;    /*2.jpg(음식사진)을 경로에 넣어서 바꿔줘야함*/
...
<ul id="nav">
  ...
  <ul>
	...
	<li><a href="/TastyPangyo/selectRes?allRes=전체조회">전체조회</a></li>
  ...
  <li> <a >리뷰 관리</a>
     <ul>
        <li><a href="/TastyPangyo/review/select?allReviews=registered_date">전체리뷰</a></li>
