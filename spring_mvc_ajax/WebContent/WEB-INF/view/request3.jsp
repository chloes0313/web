...
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=fdde9eeb70abb02b1adeab9633671a56&libraries=services"></script>
<script>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new daum.maps.LatLng(37.39481, 127.11147), // 지도의 중심좌표
        level: 5 // 지도의 확대 레벨
    };  
